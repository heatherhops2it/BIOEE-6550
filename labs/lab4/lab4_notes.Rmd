...
when you are using circular data for a year, you can choose whether to use 365 or 366 for the number of days. you can also re-calculate for leap years individually. it's up to you and your willingness to incur a certain amount of error/data gap.
