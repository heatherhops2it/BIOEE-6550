...
We will check the correlation between (1) latent energy - a measure of evapotranspiration, (2) incoming solar radiation, and (3) air temperature at midday (midday defined as hour of day equal to 12)
...
# Subset morning data (HOD < 12) for July
df_am <- df_nee %>%
